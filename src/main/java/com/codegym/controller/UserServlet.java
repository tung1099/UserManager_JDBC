...
public class UserServlet extends HttpServlet {
        ...
        try {
            switch (action) {
                ...
                case "delete":
                    ...
                    break;
                case "search":
                    showListUserByCountry(request, response);
                    break;
                case "sort":
                    showListUserSortByName(request,response);
                    break;
                case "permission":
    ...
    private void addUserPermission(HttpServletRequest request, HttpServletResponse response){
        User user = new User("GnuT", "dtroyal@gmail.com", "Vietnam");
    ...
    private void showListUserSortByName(HttpServletRequest request, HttpServletResponse response)
    ...
    private void showListUserByCountry(HttpServletRequest request, HttpServletResponse response)
        throws SQLException, IOException, ServletException {
...
//        User existingUser = userDAO.selectUSer(id);
    ...
    private void searchUserByCountry(HttpServletRequest request, HttpServletResponse response)
        ...
        List<User> listUser = userDAO.findUserByCountry(country);
        request.setAttribute("listUser", listUser);
        RequestDispatcher dispatcher = request.getRequestDispatcher("user/list.jsp");
        dispatcher.forward(request, response);
